...
public class LoanStatusController implements Initializable {
    ...
    @FXML private Group pendingGroup;
    @FXML private VBox pendingBox;
    @FXML private AnchorPane pendingAnchor;
    @FXML private Label pendingLoanValue;
    @FXML private Label pendingLoanID;
    @FXML private Group acceptedGroup;
    @FXML private VBox acceptedBox;
    @FXML private AnchorPane accceptedAnchor;
    @FXML private Label acceptedLoanValue;
    @FXML private Label acceptedLoanID;
    @FXML private Group finishedGroup;
    @FXML private VBox finishedBox;
    @FXML private AnchorPane finishedAnchor;
    @FXML private Label finishedLoanValue;
    @FXML private Label finishedLoanID;
    @FXML private Group rejectedGroup;
    @FXML private VBox rejectedBox;
    @FXML private AnchorPane rejectedAnchor;
    @FXML private Label rejectedLoanValue;
    @FXML private Label rejectedLoanID;
    @FXML private TextField SearchTF;
    @FXML private ImageView Searchbtn;
    @FXML private RadioButton ASCRB;
    @FXML private RadioButton DESCRB;
    @FXML private JFXComboBox<?> SortOptionCB;
    User currentUser;
    ...
    private void ClientAcceptedLoansCreator(User u) throws Exception {
    	for (int i = 0; i < currentUser.Loans.size(); i++) {
    		AnchorPane pane = FXMLLoader.load(this.getClass().getResource("../view/components/acceptedLoanAnchor.fxml"));
    		Label value=(Label) pane.getChildren().get(1);
    		Label id=(Label) pane.getChildren().get(3);
    ...
    private void ClientFinishedLoansCreator(User u) throws Exception {
    	for (int i = 0; i < currentUser.Loans.size(); i++) {
    		AnchorPane pane = FXMLLoader.load(this.getClass().getResource("../view/components/finishedLoanAnchor.fxml"));
    		Label value=(Label) pane.getChildren().get(1);
    		Label id=(Label) pane.getChildren().get(3);
    ...
    private void ClientRejectedLoansCreator(User u) throws Exception {
    	for (int i = 0; i < currentUser.Loans.size(); i++) {
    		AnchorPane pane = FXMLLoader.load(this.getClass().getResource("../view/components/rejectedLoanAnchor.fxml"));
    		Label value=(Label) pane.getChildren().get(1);
    		Label id=(Label) pane.getChildren().get(3);
